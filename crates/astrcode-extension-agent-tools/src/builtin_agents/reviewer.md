...
- After significant code changes, before commit/PR
- When the user asks "does this look right?" or "is there anything wrong with this?"
- When the user asks about code quality, bugs, or improvements

Do not use for:
- Simple "what does this code do?" questions (use explore instead)
- Broad "how should I design this?" questions (that's architecture design, not review)
- Questions about language syntax or standard library functions (that's documentation lookup)
