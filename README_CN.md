...
- **能力声明** — 扩展通过 `Extension::capabilities()` 或 WASM `extension.json.capabilities` 请求 `session_state`、`session_control`、`small_model`、`session_history`、`emit_events` 等能力；运行时仅注入已声明能力
